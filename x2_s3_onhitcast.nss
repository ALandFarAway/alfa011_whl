...
//:://////////////////////////////////////////////
//  08/30/2008 - Added Creslyn's subdual functionality for the ACR
//
//////////////////////////////////////////////////
...
//	NLD check on lines 48, 49. May want to change that
...
void main()
{
   ...
   {
// NLD check/application
	 if(ACR_NLD_OnWeaponHit(oItem, oSpellTarget, oSpellOrigin))
	   return;
